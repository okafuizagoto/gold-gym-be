...
const (
	...
	qInsertGoldUser = `INSERT INTO data_peserta (gold_id, gold_email,gold_password,gold_nama,gold_nomorhp,gold_nomorkartu,gold_cvv,gold_expireddate,gold_namapemegangkartu, gold_otp, gold_last_login) VALUES (?, ?,?,?,?,?,?,?,?,?, NOW())`
